...
// debugger.
//
// NOTE: Structured exceptions must be caught in functions that do not require
// object unwinding (e.g., no destructors need to be called), so we make it a
// standalone, isolated function.
