...
private:
  static timespec now()
  {
...
#elif __WINDOWS__
    // NOTE: Windows epoch starts on January 1, 1601. This magic number is
    // well-known to be the number of ticks between the Windows and UNIX
    // epochs.
    const static __int64 ticks_between_epochs = 116444736000000000i64;
    ...
    // of converting from the Windows epoch to the UNIX epoch.
    static_assert(
    ...
    filetime_in_ticks -= ticks_between_epochs;
